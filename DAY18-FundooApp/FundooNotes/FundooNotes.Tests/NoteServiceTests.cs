...
namespace FundooNotes.Tests
{
    ...
    public class NoteServiceTests
    {
        ...
        public void Setup()
        {
            ...
            _noteService = new NoteService(_mockRepo.Object, _mockUserRepo.Object, _mockProducer.Object);
        }
        ...
        public async Task GetAllNotesAsync_ShouldReturnFromCache_WhenCacheHit()
        {
            ...
            var service = new NoteService(_mockRepo.Object, _mockUserRepo.Object, _mockProducer.Object, cacheService: mockCache.Object);
